...
const envSchema = z.object({
  ...
  CLOUDFLARE_OAUTH_CLIENT_ID: z.string().trim().min(1).optional().or(z.literal("")),
  CLOUDFLARE_OAUTH_REDIRECT_URI: z.string().url().optional().or(z.literal("")),
  CLOUDFLARE_OAUTH_SCOPES: z.string().trim().min(1).optional().or(z.literal("")),
  CLOUDFLARE_OAUTH_ENABLED: envBoolean(false),
